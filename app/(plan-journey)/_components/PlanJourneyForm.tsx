...
interface Props{
    ...
    setPlannedJourney: Dispatch<SetStateAction<any[] | undefined>>
}
export default function PlanJourneyForm({setIsLoading, setPlannedJourney}:Props) {
  ...
  async function onSubmit(values: z.infer<typeof HomeHeroFormSchema>) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="">
        ...
        <Button type="submit" className="bg-citybus-primary cursor-pointer text-white min-h-14 w-full my-2">Plan your Journey</Button>
      </form>
    </Form>
  )
}