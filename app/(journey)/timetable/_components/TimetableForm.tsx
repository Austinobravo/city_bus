...
import { TimetableFormSchema } from "@/lib/schema/formSchema"
import {
  Select,
  SelectContent,
  SelectItem,
...
export default function TimetableForm() {
  ...
  function onSubmit(values: z.infer<typeof TimetableFormSchema>) {
  ...
  // ...
    ...
    const handleSingleSubmit = (name: keyof z.infer<typeof TimetableFormSchema>, value: string) => {
      toast(`Submitted ${name}`, {
        description: value || "(empty)",
      })
    }
  
    const handleClear = (name: keyof z.infer<typeof TimetableFormSchema>) => {
      form.setValue(name, "")
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="">
        ...
        />
             ...
             <FormField
                control={form.control}
                name="showReturningJourney"
                render={({ field }) => (
                    <FormItem className="w-full">
                    <FormLabel></FormLabel>
                    <Label htmlFor="showReturningJourney" className="hover:bg-accent/50 flex items-start gap-3 rounded-lg  p-3 has-[[aria-checked=true]]:border-blue-600 has-[[aria-checked=true]]:bg-blue-50 dark:has-[[aria-checked=true]]:border-blue-900 dark:has-[[aria-checked=true]]:bg-blue-950">
                    <Checkbox
                    id="showReturningJourney"
                ...
                />
        <Button type="submit" className="bg-citybus-primary text-white min-h-14 w-full my-2">Create Timetable</Button>
      </form>
    </Form>
  )
}