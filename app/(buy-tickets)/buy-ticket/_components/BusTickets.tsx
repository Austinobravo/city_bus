        ...
        <div className='flex not-lg:flex-wrap gap-10'>
            ...
            <div className='flex flex-col justify-between'>
                <div className='bg-blue-50 p-4 rounded-2xl space-y-2'>
                    <h3 className='text-gray-700 text-2xl font-medium'>All City Bus Tickets for Your Route</h3>
                    <h4 className='text-gray-500 text-lg font-medium'>Browse available tickets based on your location and travel needs across Owerri.</h4>
                ...
                <div className='bg-[#F6FEF9] p-4 rounded-2xl space-y-2'>
                    <h3 className='text-gray-700 text-2xl font-medium'>Recent Purchases</h3>
                    <h4 className='text-gray-500 text-lg font-medium'>Quickly view and rebook tickets you've bought on City Bus.</h4>
